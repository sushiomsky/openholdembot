...
{	
  ...
  CheckDlgButton(IDC_DEBUG_OPENHOLDEM_STARTER, preferences.debug_openholdem_starter() ? MF_CHECKED : MF_UNCHECKED);
...
void CDlgSAPrefs20::OnOK()
{
  ...
  preferences.SetValue(k_prefs_debug_openholdem_starter, IsDlgButtonChecked(IDC_DEBUG_OPENHOLDEM_STARTER));
	CSAPrefsSubDlg::OnOK();
}
